...
namespace SmartClinic.Data.Infraestructure
{
    public class SmartClinicDataInitializer
    {
        ...
        {
            using (var db = serviceProvider.GetService<SmartClinicContext>())
            {
        ...
        async Task InitializeDatabaseData(IServiceProvider serviceProvider, SmartClinicContext context)
        {
        ...
        public void CreateTenantSampleData(IServiceProvider serviceProvider, int tenantId)
        {
            _serviceProvider = serviceProvider;
            _userManager = serviceProvider.GetService<UserManager<ApplicationUser>>();
            var context = serviceProvider.GetService<SmartClinicContext>();

            CreateSampleData(context, tenantId);
        }

        public async Task RemoveTenantSampleData(SmartClinicContext context, UserManager<ApplicationUser> userManager, int tenantId)
        {
        ...
        private static int CreateSampleData(SmartClinicContext context, int tenantId)
        {
        ...
        static async Task<int> CreateDefaultTenant(SmartClinicContext context)
        {
        ...
        static void CreateDoctors(SmartClinicContext context, int tenantId)
        {
        ...
        static void CreatePatients(SmartClinicContext context, int tenantId)
        {
        ...
        static void CreateMedicines(SmartClinicContext context, int tenantId)
        {
            var data = new[] {
                       new {
                           Name="Tylenol",
        ...
        static void CreateTips(SmartClinicContext context, int tenantId)
        {
            var tip = new Tip()
            {
        ...
        static void CreateClinicAppointments(SmartClinicContext context, int tenantId)
        {
        ...
        static void CreateHomeAppointments(SmartClinicContext context, int tenantId)
        {
        ...
        static void CreateSummaryInfo(SmartClinicContext context, int tenantId)
        {
        ...
        private static void CreateExpensesSummaries(SmartClinicContext context, int tenantId)
        {
        ...
        private static void CreatePatientsSummaries(SmartClinicContext context, int tenantId)
        {
        ...
        private static void CreateClinicSummary(SmartClinicContext context, int tenantId)
        {
