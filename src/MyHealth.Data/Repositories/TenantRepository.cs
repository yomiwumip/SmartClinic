...
namespace SmartClinic.Data.Repositories
{
    public class TenantsRepository
    {
        ...
        private static SmartClinicDataInitializer _SmartClinicDataInitializer;
        private static IServiceProvider _serviceProvider;

        public TenantsRepository(IServiceProvider serviceProvider, SmartClinicContext dbcontext, UserManager<ApplicationUser> userManager, SmartClinicDataInitializer SmartClinicDataInitializer)
        {
            _context = dbcontext;
            _userManager = userManager;
            _SmartClinicDataInitializer = SmartClinicDataInitializer;
        ...
        public async Task<bool> AddAsync(Tenant tenant, ApplicationUser creator)
        {
            ...
            _SmartClinicDataInitializer.CreateTenantSampleData(_serviceProvider, tenant.TenantId);
        ...
        {
            await _SmartClinicDataInitializer.RemoveTenantSampleData(_context, _userManager, tenantId);
        }
    }
}
