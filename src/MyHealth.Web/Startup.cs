...
using SmartClinic.Web.AppBuilderExtensions;
...
namespace SmartClinic.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SmartClinicContext>(options => options.UseSqlServer(connection));
        ...
        public async void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, 
            SmartClinicDataInitializer dataInitializer)
        {
